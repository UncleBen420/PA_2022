from EventProducerKafka import EventProducerKafka
from EventConsumerKafka import EventConsumerKafka
import cv2
import time
import numpy as np

path = "test_video/test_video.avi"
...
vok = EventConsumerKafka(test_callback, groupid="voktest4")
vok.start(topic)

time.sleep(5)

vik = EventProducerKafka(frame_properties, prepross, prepross2, event_detector)
